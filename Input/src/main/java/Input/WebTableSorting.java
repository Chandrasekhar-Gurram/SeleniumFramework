...
public class WebTableSorting {
	 ...
	 public static void main(String[] args) {
	    ...
	    List<String> ele=vegtables.stream().map(s->s.getText()).collect(Collectors.toList());
	    List<String> ele2= ele.stream().sorted().collect(Collectors.toList());
	    Assert.assertTrue(ele.equals(ele2));
